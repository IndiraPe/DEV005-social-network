...
var k$1, goog$1 = goog$1 || {}, l = commonjsGlobal || self;
function aa$1() {
}
function ba$1(a) {
  var b2 = typeof a;
...
k$1.qa = function() {
  "undefined" != typeof goog$1 && this.g && (this.j = "Timed out after " + this.B + "ms, aborting", this.m = 8, C$1(this, "timeout"), this.abort(8));
};
function od(a, b2) {
  a.h = false;
...
function td(a) {
  if (a.h && "undefined" != typeof goog$1 && (!a.C[1] || 4 != O$1(a) || 2 != a.aa())) {
    if (a.v && 4 == O$1(a))
      Ab(a.Ha, 0, a);
  ...
  <img id="logo-2" src= "${vaca}" alt="Imagen del logo"/>  
    <div class="register">
      ...
      <div class="container-register">
        <button class="btnG"><img src="${gg}" alt="\xCDcono de google"/><span>Contin\xFAa con Google</span></button>
      ...
      <div class="login-view">
        ...
        <div class="container-login">
          <button id="button-google" class="btn">
            <img src="${goog}" alt="Imagen de Google" id="logo-google" />
